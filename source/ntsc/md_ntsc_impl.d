...
int STD_HUE_CONDITION(const md_ntsc_setup_t* setup) { return 1; }
...
static void init_filters( init_t* impl, const md_ntsc_setup_t* setup )
{
...
static void init( init_t* impl, const md_ntsc_setup_t* setup )
{
...
extern const pixel_info_t[alignment_count] md_ntsc_pixels;

/* Generate pixel at all burst phases and column alignments */
static void gen_kernel( init_t* impl, float y, float i, float q, md_ntsc_rgb_t* out_var )
{
  ...
  do
  {
    ...
    const pixel_info_t* pixel = md_ntsc_pixels;
